...
XPLMDataRef laminar_B738_fms_legs_step_ctr; // laminar/B738/fms/legs_step_ctr float
...
void findZibo737DataRefs(void) {
	...
	if ( z737_PluginId == XPLM_NO_PLUGIN_ID ) {
        ...
        if ( z737_ready == 0 ) {
             ...
             * FMS
             */
            laminar_B738_fms_legs = XPLMFindDataRef("laminar/B738/fms/legs");
            laminar_B738_fms_legs_lat = XPLMFindDataRef("laminar/B738/fms/legs_lat");
            laminar_B738_fms_legs_lon = XPLMFindDataRef("laminar/B738/fms/legs_lon");
            laminar_B738_fms_legs_alt_calc = XPLMFindDataRef("laminar/B738/fms/legs_alt_calc");
            laminar_B738_fms_legs_alt_rest1 = XPLMFindDataRef("laminar/B738/fms/legs_alt_rest1");
            laminar_B738_fms_legs_spd = XPLMFindDataRef("laminar/B738/fms/legs_spd");

            laminar_B738_fms_num_of_wpts = XPLMFindDataRef("laminar/B738/fms/num_of_wpts");
            laminar_B738_fms_legs_step_ctr = XPLMFindDataRef("laminar/B738/fms/legs_step_ctr");
